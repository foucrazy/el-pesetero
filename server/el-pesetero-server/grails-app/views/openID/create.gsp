...
<html>
	...
	<body>
		<a href="#create-openID" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="create-openID" class="content scaffold-create" role="main">
